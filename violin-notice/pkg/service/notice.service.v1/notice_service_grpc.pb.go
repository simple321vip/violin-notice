...
type NoticeServiceClient interface {
	SendNotice(ctx context.Context, in *NoticeMessage, opts ...grpc.CallOption) (*NoticeResponse, error)
}
...
func (c *noticeServiceClient) SendNotice(ctx context.Context, in *NoticeMessage, opts ...grpc.CallOption) (*NoticeResponse, error) {
	out := new(NoticeResponse)
	err := c.cc.Invoke(ctx, "/notice.service.v1.NoticeService/SendNotice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NoticeServiceServer interface {
	SendNotice(context.Context, *NoticeMessage) (*NoticeResponse, error)
...
func (UnimplementedNoticeServiceServer) SendNotice(context.Context, *NoticeMessage) (*NoticeResponse, error) {
...
func _NoticeService_SendNotice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/notice.service.v1.NoticeService/SendNotice",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NoticeServiceServer).SendNotice(ctx, req.(*NoticeMessage))
	}
...
var NoticeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "notice.service.v1.NoticeService",
